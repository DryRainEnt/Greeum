...
```bash
# 添加记忆
python3 -m greeum.cli memory add "今天开始了一个新项目。计划用Python开发Web应用程序。"

# 搜索记忆
python3 -m greeum.cli memory search "项目 Python" --limit 5

# 长期记忆分析
python3 -m greeum.cli ltm analyze --period 30d --trends

# 添加短期记忆
python3 -m greeum.cli stm add "临时备忘" --ttl 1h
